...
***
More directory structure: you can also do this via Opening Solutions and Projects inside SSMS. This produces default folders including "Queries" and "Connections" ( similar to my config folder). I should do more research to look into the benefits of using the native SSMS approach, as it may give me some best practice ideas.
***