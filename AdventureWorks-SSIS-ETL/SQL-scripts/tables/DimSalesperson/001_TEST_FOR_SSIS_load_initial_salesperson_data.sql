...
INSERT INTO AdventureWorksDW_SSIS.Sales.Dim_SalesPerson
SELECT
...
FROM staging.AdWorksOLTP.Salesperson s
LEFT JOIN staging.AdWorksOLTP.Person p ON s.BusinessEntityID = p.BusinessEntityID
